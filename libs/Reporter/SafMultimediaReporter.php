...
/**
 * This is an example Reporter based on the SafMultimedia object.  The reporter object
 ...
 * @version 1.0
 */
class SafMultimediaReporter extends Reporter
{

	// the properties in this class must match the columns returned by GetCustomQuery().
	// 'CustomFieldExample' is an example that is not part of the `saf_multimedia` table
	...
	*/
	...
	{
		$sql = "select count(1) as counter from `saf_multimedia`";
