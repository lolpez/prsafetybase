...
require_once("DAO/SafRoleCriteriaDAO.php");

/**
 * The SafRoleCriteria class extends SafRoleDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafRoleCriteria extends SafRoleCriteriaDAO
{
