...
require_once("DAO/SafHumanCriteriaDAO.php");

/**
 * The SafHumanCriteria class extends SafHumanDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafHumanCriteria extends SafHumanCriteriaDAO
{
