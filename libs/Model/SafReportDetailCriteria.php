...
require_once("DAO/SafReportDetailCriteriaDAO.php");

/**
 * The SafReportDetailCriteria class extends SafReportDetailDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafReportDetailCriteria extends SafReportDetailCriteriaDAO
{
