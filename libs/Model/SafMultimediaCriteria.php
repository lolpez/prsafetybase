...
require_once("DAO/SafMultimediaCriteriaDAO.php");

/**
 * The SafMultimediaCriteria class extends SafMultimediaDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafMultimediaCriteria extends SafMultimediaCriteriaDAO
{
