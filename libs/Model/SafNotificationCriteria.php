...
require_once("DAO/SafNotificationCriteriaDAO.php");

/**
 * The SafNotificationCriteria class extends SafNotificationDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafNotificationCriteria extends SafNotificationCriteriaDAO
{
