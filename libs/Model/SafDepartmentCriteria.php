...
require_once("DAO/SafDepartmentCriteriaDAO.php");

/**
 * The SafDepartmentCriteria class extends SafDepartmentDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafDepartmentCriteria extends SafDepartmentCriteriaDAO
{
