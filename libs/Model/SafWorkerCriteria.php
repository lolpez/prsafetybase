...
require_once("DAO/SafWorkerCriteriaDAO.php");

/**
 * The SafWorkerCriteria class extends SafWorkerDAOCriteria and is used
 ...
 * @version 1.0
 */
class SafWorkerCriteria extends SafWorkerCriteriaDAO
{
